...
export default () => (
  <Page name="home">
    ...
    <Navbar large sliding={false}>
      ...
      <NavTitle sliding>Restaurant Reservations</NavTitle>
      <NavRight>
        <Link iconIos="f7:menu" iconAurora="f7:menu" iconMd="material:menu" panelOpen="right" />
      </NavRight>
      <NavTitleLarge>Restaurant Reservations</NavTitleLarge>
    </Navbar>
    {/* Toolbar */}
    <Toolbar bottom>
      <Link>Left Link</Link>
    ...
    {/* Page content */}
    <BlockTitle>FIREBASE_APIKEY: {Vars.FIREBASE_APIKEY}</BlockTitle>
    <BlockTitle>REACT_APP_SECRET_CODE: {Vars.SECRET_CODE}</BlockTitle>
